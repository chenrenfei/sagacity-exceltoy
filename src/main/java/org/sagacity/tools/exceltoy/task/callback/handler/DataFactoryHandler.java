 ...
 * @description 用于构造数据库数据，一般用于压力测试时构造模拟数据
 * @author chenrenfei <a href="mailto:zhongxuchen@hotmail.com">联系作者</a>
 * @version id:DataFactoryHandler.java,Revision:v1.0,Date:2012-5-6 下午1:55:18
 */
public class DataFactoryHandler extends TaskExcuteHandler {
