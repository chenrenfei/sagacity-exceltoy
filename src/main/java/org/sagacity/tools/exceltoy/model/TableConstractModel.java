 ...
 * @author chenrenfei
 * @version id:TableConstractModel.java,Revision:v1.0
 */
public class TableConstractModel implements Serializable {
	...
	/**
	 * @param pkRefTableJavaName
	 *            the pkRefTableJavaName to set
	 */
	...
	/**
	 * @param pkRefJavaColName
	 *            the pkRefJavaColName to set
	 */
